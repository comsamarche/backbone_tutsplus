...
*/ 
    var ContactView = Backbone.View.extend({
        ...
        editContact: function () {
            ...
            _.each(directory.getTypes(), function(item){
                var option = $("<option/>" , {
            ...
            this.select = select.val($(this.el).find("#type").val()).insertAfter($(this.el).find(".name"));
        ...
        saveEdits: function (e) {
            ...
            $(e.target).closest("form").find("input:first-child").addClass("photo");
    ...
    var DirectoryView = Backbone.View.extend({
        ...
        renderContact: function(item){
            ...
            $(this.el).find('.contacts-list').append(contactView.render());
        },
        ...
        showForm : function(){
            $(this.el).find('#addContact').toggleClass('visible');
        }
